...
/**
 * Custom RoutingDataSource to select the correct tenant-specific DataSource.
 * It uses the 'tenantId' stored in the TenantContext and allows dynamic registration.
 */
