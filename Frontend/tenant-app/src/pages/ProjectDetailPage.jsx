        ...
        <div style={{ flex: 1, minWidth: '300px' }}>
          ...
          >
            <div
              ...
              style={{ borderRadius: 'var(--radius-md)', width: '48px', height: '48px' }}
            >
          ...
          >
            {currentProject?.description ||
              'Build, track and release great software with Trackify.'}
          </p>
        </div>
        ...
        {viewMode === 'BOARD' && activeSprint && (
          ...
          >
            ...
            >
              ...
              <span>
                Active Sprint:{' '}
                <strong style={{ color: 'var(--text-main)' }}>{activeSprint.name}</strong>
              </span>
            </div>
          ...
          <>
            ...
            {activeSprint ? (
              ...
              >
                <LayoutDashboard
                  size={80}
                  style={{ color: 'var(--text-muted)', opacity: 0.1, marginBottom: '2rem' }}
                />
                ...
                >
                  There are no active sprints in this project. Go to the backlog to plan and start a
                  sprint.
                </p>
